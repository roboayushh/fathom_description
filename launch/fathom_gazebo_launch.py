...
def generate_launch_description():
    pkg_share = get_package_share_directory('fathom_description')
    
    # Paths
    urdf_file_path = os.path.join(pkg_share, 'urdf', 'Body.urdf.xacro')
    world_path = os.path.join(pkg_share, 'worlds', 'sauvc.world.sdf')
